...
public class Demo1FunctionalInterface {
    public static void main(String[] args) {
        ...
        Processor cubeMethodReference = Demo1FunctionalInterface::findCube;
        System.out.println("cube using method reference way = " + cubeMethodReference.process(10));
